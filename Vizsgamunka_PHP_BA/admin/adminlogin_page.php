  ...
  <div class="container-fluid">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
          ...
          Admin bejelentkezés</p>
       
        
    
            <form name="loginForm" action="admin_login.php" method="post" onsubmit="return validateForm()" class="mx-auto col-6">
        <div class="mx-auto mb-3 ">
          ...
          <div id="usernameHelp" class="form-text">Kérjük adja meg a regisztrációkor megadott felhasználó nevét.</div>
        </div>
        <div class="mx-auto mb-3 ">
